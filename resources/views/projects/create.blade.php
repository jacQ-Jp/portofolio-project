...
<div class="container mx-auto px-8 py-16 max-w-3xl">
    ...
    <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
            ...
            <label for="media" class="block text-xs font-semibold tracking-widest text-gray-700 mb-4">UPLOAD IMAGE OR VIDEO</label>
    ...
    if (isImage) {
        ...
        reader.onload = (e) => {
            const html = `
                <div class="bg-gradient-to-b from-pink-50 to-white p-6 rounded-lg border border-pink-200">
                    <p class="text-xs font-semibold tracking-widest text-gray-700 mb-4">✓ IMAGE PREVIEW:</p>
        ...
        const html = `
            <div class="bg-gradient-to-b from-blue-50 to-white p-6 rounded-lg border border-blue-200">
                <p class="text-xs font-semibold tracking-widest text-gray-700 mb-3">✓ VIDEO SELECTED:</p>
